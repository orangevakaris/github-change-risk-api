...
<html lang="en">
  ...
  <body>
    <main>
      ...
      <p class="lede">Deterministic, explainable risk signals for a public GitHub compare range. It reads GitHub change metadata only: no repository execution, private access, or live-target probing.</p>
      <div class="grid">
